...
insert into price_plan (plan_name, sms_price, call_price) values ('call 301', 1.95, 0.90);
insert into price_plan (plan_name, sms_price, call_price) values ('call 401', 1.95, 0.90);